  ...
  return (
    <>
      <div>
        ...
        <div className="flex justify-evenly mt-[10vh] ">
        ...
        <footer className="text-center bg-cyan-950 mt-[10vh]">
          <div className="mx-auto w-full max-w-screen-xl">
            ...
            <div class="px-4 py-6  md:flex md:items-center lg:justify-between">
              <span class="text-sm text-white">
                © 2024 <a href="https://flowbite.com/">SENA</a>. All Rights
                Reserved.
              </span>
